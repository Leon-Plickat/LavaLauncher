...
[lib-infinitesimal](https://git.sr.ht/~leon_plickat/lib-infinitesimal)
(Optionally as meson subproject). To compile LavaLauncher with SVG image
support, it additionally depends on librsvg.
